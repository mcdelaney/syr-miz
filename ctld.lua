...
ctld.vehiclesForTransportBLUE = { "M1097 Avenger", "M1045 HMMWV TOW", "M1043 HMMWV Armament" } -- vehicles to load onto c130 - Alternatives {"M1128 Stryker MGS","M1097 Avenger"}
...
ctld.JTAC_LIMIT_BLUE = 100 -- max number of JTAC Crates for the BLUE Side
...
ctld.pickupZones = {
    ...
    { "logizone-Al Quasyr", "blue", -1, "no", 2 },
    { "logizone-King Hussein Air College", "blue", -1, "no", 2 },
    { "US-Handywind", "blue", -1, "no", 2 },
...
ctld.wpZones = {
    ...
    { "wpzone8", "none","yes", 2 },
    { "wpzone9", "none","yes", 2 },
    { "wpzone10", "none","no", 2 }, -- Both sides as its set to 0
}
